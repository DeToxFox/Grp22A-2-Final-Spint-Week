...
def room_four():
    ...
    chassis_ctrl.move_with_distance(0, 5)
    chassis_ctrl.move_with_distance(0, 5.25)
    # rotate to face the door
    chassis_ctrl.rotate_with_degree(rm_define.anticlockwise, 90)
    gimbal_ctrl.recenter()  # added in extra
    # Calls the "Scan for a marker" function
...
def return_to_start_of_course(1):
    pass


def move_to_room_from_start(1):
    pass
...
def scan_for_person_and_play_sound():
    global person_found
    vision_ctrl.enable_detectoin(rm_define.vision_detection_people)
    person_found = False
